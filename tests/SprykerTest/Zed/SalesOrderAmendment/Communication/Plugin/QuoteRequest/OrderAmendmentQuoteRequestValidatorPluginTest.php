 ...
 * @group Plugin
 * @group QuoteRequest
 * @group OrderAmendmentQuoteRequestValidatorPluginTest
 * Add your own group annotations below this line
 */
class OrderAmendmentQuoteRequestValidatorPluginTest extends Unit
{
    /**
    ...
    public function testShouldReturnErrorWhenCartIsInAmendmentProcessByQuoteProcessFlow(): void
    {
        ...
        // Arrange
        $quoteRequestResponseTransfer = (new OrderAmendmentQuoteRequestValidatorPlugin())
